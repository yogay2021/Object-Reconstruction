...
def icp(source,target,voxel_size,max_correspondence_distance_coarse,max_correspondence_distance_fine,
    ...
    if method == "colored-icp":
        result_icp = open3d.pipelines.registration.registration_colored_icp(source,target,voxel_size, np.identity(4),
                                                           open3d.pipelines.registration.ICPConvergenceCriteria(relative_fitness = 1e-8,
